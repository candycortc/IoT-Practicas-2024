...
/****************************************
 * que onda el Isaa c no toco esto
 * fue Laura
 * 
 * 
 * 
 * 
  Define Constants
****************************************/
#define WIFISSID "Vlac-hs" //WIFI SSID aqui
#define PASSWORD "Alfanumerica" // WIFI pwd
#define TOKEN "BBUS-mtIvtHjsvtm9U776Fqqz6BE5AKesGD" // Ubidots TOKEN ID el mismo que usamos en clase lo sacan de Ubidtos
#define MQTT_CLIENT_NAME "my-mqtt-esp32" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "my-mqtt-esp32" // Nombre del dispositivo a crear
